...
GITBUCKET_URL=https://github.com/takezoe/gitbucket/releases/download/${GITBUCKET_VERSION}/gitbucket.war
...
fetch_remote_file $GITBUCKET_URL SOURCES/gitbucket-${GITBUCKET_VERSION}.war
...
echo "Version to package is $GITBUCKET_VERSION powered by Apache Tomcat $TOMCAT_VERSION"
...
rpmbuild -bb --define="_topdir $PWD" --define="_tmppath $PWD/TEMP" --define="TOMCAT_REL $TOMCAT_VERSION" --define="GITBUCKET_REL $GITBUCKET_VERSION"  SPECS/mygitbucket.spec
