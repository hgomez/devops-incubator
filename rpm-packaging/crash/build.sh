...
CRASH_URL=http://central.maven.org/maven2/org/crashub/crash.distrib/${VERSION}/crash.distrib-${VERSION}.tar.gz
...
fetch_remote_file $CRASH_URL SOURCES/crash.distrib-${VERSION}.tar.gz
